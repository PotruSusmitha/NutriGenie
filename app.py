        ...
        if not ing_input:
            ...
            with st.spinner("Genie is analyzing health safety..."):
                ...
                if is_blocked:
                    ...
                    st.download_button(
                    label="📥 Download Recipe",         # The text on the button
                    data=final_recipe,                  # The text content to be downloaded
                    file_name="Nutrigenie_Recipe.txt",  # The default name of the downloaded file
                    mime="text/plain"                   # Tells the browser it's a simple text file
                    )
